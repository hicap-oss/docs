...
The Hicap API gives you access to 42 foundation models from OpenAI, Anthropic, Google Gemini, and more — through a single OpenAI-compatible endpoint. Use any standard OpenAI SDK and start building in under 5 minutes.
...
That's it. You just called the Hicap API. The same code works with any of the [42 supported models](/providers/table-comparison) — just change the `model` parameter.
...
[View all 42 models →](/providers/table-comparison)
