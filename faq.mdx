...
<AccordionGroup>
  <Accordion title="What exactly does Hicap do in plain terms?">
    Hicap gives you fast, secure access to top AI models — like GPT-5.4, Claude Opus 4.6, and Gemini 3.1 Pro — at a fraction of the usual cost. We bulk-reserve compute from leading cloud providers and pass the savings to you, all through a simple API.
  </Accordion>
