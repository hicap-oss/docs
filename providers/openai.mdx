---
title: 'OpenAI'
description: 'OpenAI models available through the Hicap API'
---

All OpenAI models below are accessible through the **Hicap API** using the standard [OpenAI API spec](https://platform.openai.com/docs/api-reference). Point your OpenAI SDK at `https://api.hicap.ai/v1` and use any model ID listed here. Pricing is sourced from [hicap.ai/models.json](https://hicap.ai/models.json).

## gpt-5.4

GPT-5.4 is OpenAI's most advanced model, offering a massive 1.05M token context window with state-of-the-art reasoning, coding, and multimodal capabilities. It features long-context pricing tiers above 272K tokens for cost-efficient processing of very large inputs.
...
<Columns cols={1}>
    <div>
        ...
        <ul className='mb-6'>
            <li>* 1,050,000 context window</li>
            <li>* Long-context pricing above 272,000 tokens</li>
        </ul>

        Pricing: $2.50 / $15.00 / $0.25 (input / output / cache) per 1M tokens. Long-context: $5.00 / $22.50 input / output per 1M tokens.
...
<Columns cols={1}>
    <div>
        ...
        Pricing: $1.75 / $14.00 / $0.175 (input / output / cache) per 1M tokens.
