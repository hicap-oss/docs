---
title: 'Overview'
description: 'Hicap gives you secure, enterprise-ready access to OpenAI and Anthropic models, cutting inference costs by 40% with live token optimization.'
---
...
Go to the [hicap portal](https://portal.hicap.ai/signin)

### **Step 2** Authenticate via Azure AD B2C

Click the **“Azure Active Directory B2C”** button to log in using your organization’s Azure credentials.
